...
config['prices'] = {}
config['prices']['use_prices'] = 'True'
config['prices']['sbsp'] = "C:/Users/Dan Travers/Google Drive/Projects/Explore/EPEX-Prices/Elexon prices/ssphourly.csv"
config['prices']['epex'] = "C:/Users/Dan Travers/Google Drive/Projects/Explore/EPEX-Prices/Elexon prices/epex_prices.csv"
...
with open(os.path.join(os.path.dirname(os.path.realpath(__file__)),'config/pvstream.ini'), 'w') as configfile:
